...
- `catalogo.html`: Navegação principal por categorias
- `pisos/`, `forros/`, `escadas/`: Folders com recursos de mídia
- `pisos-*.html`: Subpáginas detalhadas de cada coleção
